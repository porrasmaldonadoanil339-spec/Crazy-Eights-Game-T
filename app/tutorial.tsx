...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    icon: "skull",
    iconColor: "#9B59B6",
    body: "El Joker obliga al rival a robar 5 cartas. Puede encadenarse con 7 o Joker. Es la carta más poderosa. ¡Guárdala para el momento decisivo!",
    centerCard: { id: "cj", suit: "hearts", rank: "Joker" },
    centerBadge: { label: "+5", color: "#9B59B6" },
  },
  {
    title: "El Tres — Salto",
    subtitle: "Vuelve a jugar",
    icon: "arrow-forward-circle",
    iconColor: "#27AE60",
    body: "Al jugar un 3, el rival pierde su turno y tú juegas de nuevo. Cancela cualquier castigo pendiente. ¡Perfecta para salir de apuros!",
    centerCard: { id: "c3", suit: "diamonds", rank: "3" },
    centerBadge: { label: "SKIP", color: "#27AE60" },
  },
  {
    title: "El Diez — Reversa",
    subtitle: "Cambia el sentido",
    icon: "refresh",
    iconColor: "#16A085",
    body: "Al jugar un 10, el sentido del juego se invierte. En partidas de 2 jugadores actúa como un salto extra, dándote dos turnos seguidos.",
    centerCard: { id: "c10", suit: "spades", rank: "10" },
