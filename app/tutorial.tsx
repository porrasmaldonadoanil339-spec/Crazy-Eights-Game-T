...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    icon: "star",
    iconColor: Colors.gold,
    body: "El 8 es el comodín — puedes jugarlo en cualquier momento sin importar palo o número. Tras jugarlo, debes elegir el nuevo palo dentro del tiempo límite.",
  ...
  },
  {
    ...
    icon: "flash",
    iconColor: "#E91E63",
    body: "Al jugar un As, tu rival roba 1 carta. Si el rival tiene otro As, puede acumular el castigo encadenando.",
    centerCard: { id: "ca", suit: "spades", rank: "A" },
    centerBadge: { label: "+1", color: "#E91E63" },
  },
  {
    ...
    icon: "flash",
    iconColor: "#E74C3C",
    body: "Al jugar un 2, tu rival roba 2 cartas. Acumulable con otro 2 — encadena para castigar al rival.",
    centerCard: { id: "c2", suit: "hearts", rank: "2" },
    centerBadge: { label: "+2", color: "#E74C3C" },
  },
  {
    title: "El Tres — +3 Cartas",
    subtitle: "Acumulable",
    icon: "flash",
    iconColor: "#F39C12",
    body: "Al jugar un 3, tu rival roba 3 cartas. Acumulable con otro 3 — el castigo crece rápido.",
    centerCard: { id: "c3", suit: "diamonds", rank: "3" },
    centerBadge: { label: "+3", color: "#F39C12" },
  },
  {
    title: "La J — Pierde Turno",
    subtitle: "Salta al rival",
    icon: "ban",
    iconColor: "#27AE60",
    body: "Al jugar una J, tu rival pierde su turno completo. Perfecta para frenar al rival cuando le quedan pocas cartas.",
    centerCard: { id: "cj1", suit: "clubs", rank: "J" },
    centerBadge: { label: "SKIP", color: "#27AE60" },
  },
  {
    title: "La Q — Cambia Sentido",
    subtitle: "Invierte el orden",
    icon: "refresh",
    iconColor: "#16A085",
    body: "Al jugar una Q, el sentido del juego cambia. En partidas con varios jugadores, esto puede romper estrategias enteras.",
    centerCard: { id: "cq", suit: "hearts", rank: "Q" },
    centerBadge: { label: "REV", color: "#16A085" },
  },
  {
    title: "La K — Turno Extra",
    subtitle: "Juega de nuevo",
    icon: "arrow-forward-circle",
    iconColor: "#3498DB",
    body: "Al jugar una K, obtienes un turno adicional inmediato. Encadena Ks para vaciar la mano más rápido.",
    centerCard: { id: "ck", suit: "spades", rank: "K" },
    centerBadge: { label: "+1 TURN", color: "#3498DB" },
  },
  {
    title: "El Joker — +4 Cartas",
    subtitle: "La carta más poderosa",
    icon: "skull",
    iconColor: "#9B59B6",
    body: "El Joker obliga al rival a robar 4 cartas y se puede jugar EN CUALQUIER MOMENTO sin importar palo ni número. Guárdalo para el golpe final.",
    centerCard: { id: "cjk", suit: "hearts", rank: "Joker" },
    centerBadge: { label: "+4", color: "#9B59B6" },
  },
  {
    title: "Robar Cartas",
