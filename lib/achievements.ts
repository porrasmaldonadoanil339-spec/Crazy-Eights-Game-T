...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: "event_versatile",    title: "Versátil de Eventos",      description: "Gana al menos 1 partida en 3 eventos distintos.", icon: "trophy",        iconColor: "#1ABC9C", target: 3,    coinsReward: 250,  xpReward: 600,  rarity: "epic" },
  // ─── Win milestones ──────────────────────────────────────────────
  ...
  // ─── Battle Pass ──────────────────────────────────────────────────
  { id: "bp_tier_10",       title: "Camino Desbloqueado",         description: "Alcanza el nivel 10 del Camino.",      icon: "star",             iconColor: "#1A8FC1", target: 10,   coinsReward: 50,   xpReward: 100,  rarity: "rare" },
  { id: "bp_tier_40",       title: "Camino Élite",                description: "Alcanza el nivel 40 del Camino.",      icon: "medal",            iconColor: "#D4AF37", target: 40,   coinsReward: 200,  xpReward: 500,  rarity: "epic" },
  { id: "bp_tier_80",       title: "Camino Legendario",           description: "Alcanza el nivel 80 del Camino.",      icon: "trophy",           iconColor: "#A855F7", target: 80,   coinsReward: 1000, xpReward: 2000, rarity: "legendary" },
  // ─── Cards played stats ───────────────────────────────────────────
  ...
  // Battle Pass expansion
  { id: "bp_tier_150",      title: "Camino Épico",      description: "Alcanza el nivel 150 del Camino.",     icon: "medal",            iconColor: "#9B59B6", target: 150,   coinsReward: 500,  xpReward: 1200,  rarity: "epic" },
  { id: "bp_tier_200",      title: "Camino Legendario", description: "Alcanza el nivel 200 del Camino.",     icon: "trophy",           iconColor: "#D4AF37", target: 200,   coinsReward: 1200, xpReward: 3000,  rarity: "legendary" },
  { id: "bp_tier_250",      title: "Camino Supremo",    description: "Alcanza el nivel 250 del Camino.",     icon: "diamond",          iconColor: "#FF4400", target: 250,   coinsReward: 2500, xpReward: 6000,  rarity: "legendary" },
  { id: "bp_tier_300",      title: "Camino Divino",     description: "Alcanza el nivel 300 del Camino.",     icon: "infinite",         iconColor: "#A855F7", target: 300,   coinsReward: 5000, xpReward: 12000, rarity: "legendary" },
  // Cards played expansion
  ...
  // Battle pass collection
  { id: "bp_collector_10",  title: "10 Premios del Camino",        description: "Reclama 10 recompensas del Camino.",    icon: "gift",             iconColor: "#1A8FC1", target: 10,    coinsReward: 50,   xpReward: 120,   rarity: "common" },
  { id: "bp_collector_50",  title: "50 Premios del Camino",        description: "Reclama 50 recompensas del Camino.",    icon: "gift",             iconColor: "#D4AF37", target: 50,    coinsReward: 200,  xpReward: 500,   rarity: "rare" },
  { id: "bp_collector_100", title: "100 Premios del Camino",       description: "Reclama 100 recompensas del Camino.",   icon: "gift",             iconColor: "#A855F7", target: 100,   coinsReward: 600,  xpReward: 1500,  rarity: "epic" },
  // Comeback milestones
