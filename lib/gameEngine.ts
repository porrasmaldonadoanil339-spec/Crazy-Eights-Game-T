...
const GM: Record<string, Record<string, string>> = {
  ...
  youChoseSuit:   { es:"Elegiste {s} — Turno del CPU...",en:"You chose {s} — CPU's turn...",pt:"Você escolheu {s} — Turno do CPU...",fr:"Vous avez choisi {s} — Tour du CPU...",de:"Du wähltest {s} — CPU ist dran...",it:"Hai scelto {s} — Turno del CPU...",tr:"{s} seçtin — CPU sırası...",ru:"Вы выбрали {s} — Ход CPU...",pl:"Wybrałeś {s} — Tura CPU...",nl:"Je koos {s} — CPU is aan de beurt...",sv:"Du valde {s} — CPU:s tur...",da:"Du valgte {s} — CPU's tur...",fi:"Valitsit {s} — CPU:n vuoro...",no:"Du valgte {s} — CPU sin tur...",zh:"你选了{s} — CPU的回合...",ja:"{s}を選んだ — CPUのターン...",ko:"{s} 선택 — CPU 차례...",hi:"आपने {s} चुना — CPU की बारी...",th:"คุณเลือก {s} — ถึงตา CPU...",vi:"Bạn chọn {s} — Lượt của CPU...",id:"Kamu memilih {s} — Giliran CPU...",ar:"اخترت {s} — دور CPU..." },
  ...
  player3skip:    { es:"3 → CPU pierde su turno. ¡Juegas de nuevo!",en:"3 → CPU loses their turn. Play again!",pt:"3 → CPU perde a vez. Jogue de novo!",fr:"3 → CPU perd son tour. Rejouez !",de:"3 → CPU verliert seinen Zug. Nochmal spielen!",it:"3 → CPU perde il turno. Gioca ancora!",tr:"3 → CPU sırasını kaybetti. Tekrar oyna!",ru:"3 → CPU пропускает ход. Играй снова!",pl:"3 → CPU traci turę. Graj ponownie!",nl:"3 → CPU verliest zijn beurt. Speel opnieuw!",sv:"3 → CPU förlorar sin tur. Spela igen!",da:"3 → CPU mister sin tur. Spil igen!",fi:"3 → CPU menettää vuoronsa. Pelaa uudelleen!",no:"3 → CPU mister turen. Spill igjen!",zh:"3 → CPU失去回合，你再出一张！",ja:"3 → CPUがターンをスキップ。もう一度！",ko:"3 → CPU가 턴 잃기. 다시 플레이!",hi:"3 → CPU की बारी छूटी। फिर खेलें!",th:"3 → CPU เสียตาเดิน เล่นอีกครั้ง!",vi:"3 → CPU mất lượt. Chơi lại!",id:"3 → CPU kehilangan giliran. Main lagi!",ar:"3 → CPU يخسر دوره. العب مجدداً!" },
  playerAceCancel:{ es:"¡As! Robo cancelado — Turno del CPU",en:"Ace! Draw cancelled — CPU's turn",pt:"Ás! Compra cancelada — Vez do CPU",fr:"As ! Pioche annulée — Tour du CPU",de:"Ass! Ziehen abgebrochen — CPU ist dran",it:"Asso! Pesca annullata — Turno del CPU",tr:"As! Çekme iptal — CPU sırası",ru:"Туз! Добор отменён — Ход CPU",pl:"As! Dobieranie anulowane — Tura CPU",nl:"Aas! Trek geannuleerd — CPU is aan de beurt",sv:"Ess! Drag avbrutet — CPU:s tur",da:"Es! Trækning annulleret — CPU's tur",fi:"Ässä! Nosto peruutettu — CPU:n vuoro",no:"Ess! Trekk kansellert — CPU sin tur",zh:"A！摸牌取消 — CPU的回合",ja:"エース！引くのキャンセル — CPUのターン",ko:"에이스! 드로우 취소 — CPU 차례",hi:"ए! ड्रॉ रद्द — CPU की बारी",th:"A! ยกเลิกการจั่ว — ถึงตา CPU",vi:"A! Hủy rút bài — Lượt của CPU",id:"As! Ambil dibatalkan — Giliran CPU",ar:"آس! السحب ملغى — دور CPU" },
  ...
  cpuTurn:        { es:"Turno del CPU...",en:"CPU's turn...",pt:"Vez do CPU...",fr:"Tour du CPU...",de:"CPU ist dran...",it:"Turno del CPU...",tr:"CPU sırası...",ru:"Ход CPU...",pl:"Tura CPU...",nl:"CPU is aan de beurt...",sv:"CPU:s tur...",da:"CPU's tur...",fi:"CPU:n vuoro...",no:"CPU sin tur...",zh:"CPU的回合...",ja:"CPUのターン...",ko:"CPU 차례...",hi:"CPU की बारी...",th:"ถึงตา CPU...",vi:"Lượt của CPU...",id:"Giliran CPU...",ar:"دور CPU..." },
  ...
  noCards:        { es:"Sin cartas — Turno del CPU",en:"No cards — CPU's turn",pt:"Sem cartas — Vez do CPU",fr:"Pas de cartes — Tour du CPU",de:"Keine Karten — CPU ist dran",it:"Nessuna carta — Turno del CPU",tr:"Kart yok — CPU sırası",ru:"Нет карт — Ход CPU",pl:"Brak kart — Tura CPU",nl:"Geen kaarten — CPU is aan de beurt",sv:"Inga kort — CPU:s tur",da:"Ingen kort — CPU's tur",fi:"Ei kortteja — CPU:n vuoro",no:"Ingen kort — CPU sin tur",zh:"无牌 — CPU的回合",ja:"カードなし — CPUのターン",ko:"카드 없음 — CPU 차례",hi:"कोई कार्ड नहीं — CPU की बारी",th:"ไม่มีไพ่ — ถึงตา CPU",vi:"Không có bài — Lượt của CPU",id:"Tidak ada kartu — Giliran CPU",ar:"لا بطاقات — دور CPU" },
  ...
  noPlay:         { es:"Sin jugada — Turno del CPU",en:"No play — CPU's turn",pt:"Sem jogada — Vez do CPU",fr:"Pas de jeu — Tour du CPU",de:"Kein Zug — CPU ist dran",it:"Nessuna mossa — Turno del CPU",tr:"Hamle yok — CPU sırası",ru:"Нет хода — Ход CPU",pl:"Brak ruchu — Tura CPU",nl:"Geen zet — CPU is aan de beurt",sv:"Inget drag — CPU:s tur",da:"Intet træk — CPU's tur",fi:"Ei siirtoa — CPU:n vuoro",no:"Ingen trekk — CPU sin tur",zh:"无法出牌 — CPU的回合",ja:"プレイ不可 — CPUのターン",ko:"플레이 없음 — CPU 차례",hi:"कोई चाल नहीं — CPU की बारी",th:"ไม่มีการเล่น — ถึงตา CPU",vi:"Không có nước đi — Lượt của CPU",id:"Tidak ada langkah — Giliran CPU",ar:"لا خطوة — دور CPU" },
