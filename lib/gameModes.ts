...
export const GAME_MODES: GameModeConfig[] = [
  ...
  },
  {
    ...
    name: "Relámpago",
    nameShort: "Rayo",
    description: "5 cartas, partida rápida contra rivales reales. ¡El primero en vaciar gana!",
    cardsPerPlayer: 5,
    icon: "flash",
    iconLib: "Ionicons",
    color: "#FFD700",
  ...
  },
  {
    ...
    name: "Desafíos",
    nameShort: "Desafíos",
    description: "Retos diarios con reglas especiales y recompensas únicas contra otros jugadores.",
    cardsPerPlayer: 7,
    icon: "ribbon",
    iconLib: "Ionicons",
    color: "#9B59B6",
