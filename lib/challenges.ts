...
export const CHALLENGES_POOL: Omit<Challenge, "progress" | "completed" | "claimed" | "resetAt">[] = [
  ...
  { id: "c10", title: "Maestro Ranked", titleEn: "Ranked Master", titlePt: "Mestre Ranked", description: "Gana 1 partida clasificatoria", descriptionEn: "Win 1 ranked match", descriptionPt: "Vença 1 partida ranqueada", icon: "trophy", target: 1, type: "wins", modeFilter: "ranked", coinReward: 130, xpReward: 260 },
  ...
  { id: "c20", title: "Rayo Veloz", titleEn: "Fast Lightning", titlePt: "Raio Veloz", description: "Gana 2 partidas en modo Relámpago", descriptionEn: "Win 2 matches in Lightning mode", descriptionPt: "Vença 2 partidas no modo Relâmpago", icon: "flash", target: 2, type: "wins", modeFilter: "lightning", coinReward: 140, xpReward: 280 },
  ...
  { id: "c22", title: "Veterano Ranked", titleEn: "Ranked Veteran", titlePt: "Veterano Ranqueado", description: "Gana 2 partidas clasificatorias", descriptionEn: "Win 2 ranked matches", descriptionPt: "Vença 2 partidas ranqueadas", icon: "star", target: 2, type: "wins", modeFilter: "ranked", coinReward: 180, xpReward: 360 },
