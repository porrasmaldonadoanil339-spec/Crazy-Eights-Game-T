...
const ITEM_TL: Record<string, TL4> = {
  ...
  // ── Effects ───────────────────────────────────────────────────────────────
  effect_fire:     ["Flames",          "Chamas",           "Cards played burst into flames.",        "Cartas jogadas explodem em chamas."     ],
  effect_thunder:  ["Lightning",       "Raios",            "Electric bolts on every play.",         "Raios elétricos em cada jogada."        ],
  effect_galaxy:   ["Galaxy",          "Galáxia",          "Cosmic particles shine when played.",    "Partículas cósmicas brilham ao jogar."  ],
  effect_holy:     ["Holy",            "Sagrado",          "Holy light with every card.",            "Luz sagrada com cada carta."            ],
  effect_darkness: ["Darkness",        "Escuridão",        "Shadows consume the table.",             "Sombras consomem a mesa."               ],
  effect_supernova:["Supernova",       "Supernova",        "Stellar explosion on each play.",        "Explosão estelar a cada jogada."        ],
  effect_ultimate: ["Ultimate",        "Definitivo",       "The final effect. Beyond all.",          "O efeito definitivo. Além de tudo."     ],
  effect_snow:     ["Snow",            "Neve",             "Snowflakes drift on every card.",        "Flocos de neve na mesa."                ],
  effect_rain:     ["Rain",            "Chuva",            "Raindrops on the game.",                "Gotas de chuva no jogo."                ],
  effect_wind:     ["Wind",            "Vento",            "Cards dance in the breeze.",             "Cartas dançam na brisa."                ],
  effect_earth:    ["Earth",           "Terra",            "Ground shaking on each play.",           "Terra tremendo a cada jogada."          ],
  effect_water:    ["Water",           "Água",             "Waves wash over the table.",             "Ondas lavam sobre a mesa."              ],
  effect_ice:      ["Ice",             "Gelo",             "Frost crystallizes on cards.",           "Gelo cristaliza nas cartas."            ],
  effect_smoke:    ["Smoke",           "Fumaça",           "Smoke trails every move.",               "Fumaça segue cada movimento."           ],
  effect_shadow_fx:["Shadow",          "Sombra",           "Dark shadows follow each card.",         "Sombras escuras seguem cada carta."     ],
  effect_lightning:["Lightning Bolt",  "Raio",             "Electric flash on play.",               "Flash elétrico ao jogar."               ],
  effect_poison:   ["Poison",          "Veneno",           "Toxic droplets at every move.",          "Gotículas tóxicas a cada jogada."       ],
  effect_crystal:  ["Crystal",         "Cristal",          "Crystal shards scatter on play.",        "Fragmentos de cristal ao jogar."        ],
  effect_blood:    ["Blood",           "Sangue",           "Crimson droplets on every card.",        "Gotas carmesim em cada carta."          ],
  effect_lightning2:["Thunder Strike", "Raio de Trovão",   "Massive thunder on every play.",         "Trovão massivo a cada jogada."          ],
  effect_blizzard: ["Blizzard",        "Nevasca",          "Blizzard engulfs the table.",            "Nevasca engole a mesa."                 ],
  effect_tornado:  ["Tornado",         "Tornado",          "Whirlwind spins cards.",                 "Redemoinho gira as cartas."             ],
  effect_quake:    ["Earthquake",      "Terremoto",        "Table shakes on every play.",            "Mesa treme a cada jogada."              ],
  effect_tsunami:  ["Tsunami",         "Tsunami",          "Giant wave floods the table.",           "Onda gigante inunda a mesa."            ],
  effect_meteor:   ["Meteor",          "Meteoro",          "Meteors crash with each card.",          "Meteoros colidem com cada carta."       ],
  effect_vortex:   ["Vortex",          "Vórtice",          "Spiraling vortex on plays.",             "Vórtice espiral nas jogadas."           ],
  effect_aurora:   ["Aurora",          "Aurora",           "Northern lights on the table.",          "Auroras boreais na mesa."               ],
  effect_phoenix_fx:["Phoenix",        "Fênix",            "Phoenix rises with every win.",          "Fênix surge a cada vitória."            ],
  effect_dragon:   ["Dragon",          "Dragão",           "Dragon fire scorches each card.",        "Fogo de dragão em cada carta."          ],
  effect_ninja_fx: ["Ninja",           "Ninja",            "Shadow clone on every play.",            "Clone sombra a cada jogada."            ],
  effect_cosmic:   ["Cosmic",          "Cósmico",          "Stars align on each move.",              "Estrelas se alinham a cada jogada."     ],
  effect_matrix:   ["Matrix",          "Matrix",           "Green code rains down.",                 "Código verde cai como chuva."           ],
  effect_neon_fx:  ["Neon",            "Neon",             "Neon glow pulses on plays.",             "Brilho neon pulsa nas jogadas."         ],
  effect_glitch:   ["Glitch",          "Glitch",           "Reality glitches with each play.",       "Realidade falha a cada jogada."         ],
  effect_spirit:   ["Spirit",          "Espírito",         "Spectral spirits play with you.",        "Espectros jogam com você."              ],
  ...
  effect_divine_e_v:["Divine Judgment","Julgamento Divino","Justice light over the table.",          "Luz de justiça sobre a mesa."           ],
