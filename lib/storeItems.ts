...
export const CARD_DESIGNS: StoreItem[] = [
  ...
  { id: "face_default",    category: "card_design", name: "Clásico Blanco",     description: "Diseño limpio y clásico.",                price: 0,   preview: "card", previewColor: "#F8F4E8", rarity: "common",    isDefault: true, backColors: ["#F8F4E8", "#2C2C2C", "#D4AF37"], backAccent: "#D4AF37" },
  { id: "face_ivory",      category: "card_design", name: "Marfil Real",        description: "Calidez clásica del marfil.",             price: 40,  preview: "card", previewColor: "#FFFFF0", rarity: "common",    backColors: ["#FFFFF0", "#1A1A1A", "#C8A800"], backAccent: "#C8A800" },
  { id: "face_cream",      category: "card_design", name: "Crema Suave",        description: "Suavidad natural y relajante.",           price: 40,  preview: "card", previewColor: "#FFFACD", rarity: "common",    backColors: ["#FFFACD", "#333300", "#B8A000"], backAccent: "#B8A000" },
  { id: "face_mint",       category: "card_design", name: "Menta Fresca",       description: "Frescura verde y limpia.",                price: 50,  preview: "card", previewColor: "#E8FFF0", rarity: "common",    backColors: ["#E8FFF0", "#004020", "#00AA44"], backAccent: "#00AA44" },
  { id: "face_sky",        category: "card_design", name: "Cielo Claro",        description: "Azul cielo despejado.",                   price: 50,  preview: "card", previewColor: "#E8F4FF", rarity: "common",    backColors: ["#E8F4FF", "#001A40", "#0066CC"], backAccent: "#0066CC" },
  { id: "face_rose",       category: "card_design", name: "Rosa Suave",         description: "Tono rosado elegante y delicado.",        price: 50,  preview: "card", previewColor: "#FFF0F5", rarity: "common",    backColors: ["#FFF0F5", "#400020", "#CC0055"], backAccent: "#CC0055" },
  { id: "face_lavender",   category: "card_design", name: "Lavanda",            description: "Malva suave y relajante.",                price: 50,  preview: "card", previewColor: "#F0E8FF", rarity: "common",    backColors: ["#F0E8FF", "#200040", "#8800CC"], backAccent: "#8800CC" },
  { id: "face_peach",      category: "card_design", name: "Durazno",            description: "Cálido y vibrante color durazno.",        price: 60,  preview: "card", previewColor: "#FFEEDD", rarity: "common",    backColors: ["#FFEEDD", "#402000", "#CC6600"], backAccent: "#CC6600" },
  { id: "face_sand",       category: "card_design", name: "Arena Cálida",       description: "Calidez del desierto en tus manos.",      price: 60,  preview: "card", previewColor: "#F5E8D0", rarity: "common",    backColors: ["#F5E8D0", "#402800", "#AA7000"], backAccent: "#AA7000" },
  { id: "face_steel",      category: "card_design", name: "Acero Suave",        description: "Gris metálico moderno.",                  price: 60,  preview: "card", previewColor: "#F0F4F8", rarity: "common",    backColors: ["#F0F4F8", "#202530", "#4466AA"], backAccent: "#4466AA" },
  { id: "face_linen",      category: "card_design", name: "Lino Natural",       description: "Textura natural de tejido de lino.",      price: 70,  preview: "card", previewColor: "#FAF0E6", rarity: "common",    backColors: ["#FAF0E6", "#3A2A10", "#8A6A30"], backAccent: "#8A6A30" },
  { id: "face_paper",      category: "card_design", name: "Papel Antiguo",      description: "Textura de papel envejecido.",            price: 70,  preview: "card", previewColor: "#F5ECD7", rarity: "common",    backColors: ["#F5ECD7", "#3A2000", "#996600"], backAccent: "#996600" },
  { id: "face_snow",       category: "card_design", name: "Nieve Pura",         description: "Blanco inmaculado como la nieve.",        price: 70,  preview: "card", previewColor: "#FAFAFF", rarity: "common",    backColors: ["#FAFAFF", "#000040", "#0000AA"], backAccent: "#0000AA" },
  { id: "face_ash",        category: "card_design", name: "Gris Ceniza",        description: "Gris tenue y minimalista.",               price: 70,  preview: "card", previewColor: "#F2F2F2", rarity: "common",    backColors: ["#F2F2F2", "#222222", "#666666"], backAccent: "#666666" },
  ...
  { id: "face_fog",        category: "card_design", name: "Neblina",            description: "Gris azulado como la niebla.",            price: 80,  preview: "card", previewColor: "#E8EEF5", rarity: "common",    backColors: ["#E8EEF5", "#1A2030", "#3A5080"], backAccent: "#3A5080" },
  { id: "face_sage",       category: "card_design", name: "Salvia Herbal",      description: "Verde grisáceo herbal.",                  price: 80,  preview: "card", previewColor: "#EAF0E8", rarity: "common",    backColors: ["#EAF0E8", "#203020", "#507050"], backAccent: "#507050" },
  { id: "face_buff",       category: "card_design", name: "Ante Claro",         description: "Amarillo suave cálido.",                  price: 80,  preview: "card", previewColor: "#F5EDDC", rarity: "common",    backColors: ["#F5EDDC", "#3A2800", "#9A7030"], backAccent: "#9A7030" },
  // RARE (30)
  { id: "face_casino_red", category: "card_design", name: "Casino Rojo",        description: "Estilo de los grandes casinos.",          price: 90,  preview: "card", previewColor: "#FFF0F0", rarity: "rare",      backColors: ["#FFF0F0", "#8B0000", "#D4AF37"], backAccent: "#D4AF37" },
  { id: "face_navy_gold",  category: "card_design", name: "Azul Marino Dorado", description: "Elegancia náutica de alta clase.",        price: 90,  preview: "card", previewColor: "#F0F4FF", rarity: "rare",      backColors: ["#F0F4FF", "#001A4A", "#D4AF37"], backAccent: "#D4AF37" },
  { id: "face_emerald",    category: "card_design", name: "Esmeralda Casino",   description: "Verde rico de casino de lujo.",           price: 100, preview: "card", previewColor: "#F0FFF4", rarity: "rare",      backColors: ["#F0FFF4", "#004020", "#2ECC71"], backAccent: "#2ECC71" },
  { id: "face_crimson",    category: "card_design", name: "Carmesí Elegante",   description: "Rojo profundo y dominante.",              price: 100, preview: "card", previewColor: "#FFF2F2", rarity: "rare",      backColors: ["#FFF2F2", "#6B0000", "#FF3333"], backAccent: "#FF3333" },
  { id: "face_cobalt",     category: "card_design", name: "Cobalto Profundo",   description: "Azul cobalto de artista.",                price: 110, preview: "card", previewColor: "#F0F2FF", rarity: "rare",      backColors: ["#F0F2FF", "#001060", "#2244CC"], backAccent: "#2244CC" },
  { id: "face_forest",     category: "card_design", name: "Bosque Oscuro",      description: "Verde intenso del bosque profundo.",      price: 110, preview: "card", previewColor: "#F0FFF2", rarity: "rare",      backColors: ["#F0FFF2", "#002A00", "#006600"], backAccent: "#006600" },
  { id: "face_sunset2",    category: "card_design", name: "Atardecer",          description: "Mezcla cálida de naranja y rosa.",        price: 110, preview: "card", previewColor: "#FFF5EE", rarity: "rare",      backColors: ["#FFF5EE", "#5A1A00", "#FF6633"], backAccent: "#FF6633" },
  { id: "face_midnight",   category: "card_design", name: "Medianoche",         description: "Azul oscuro de la noche profunda.",       price: 120, preview: "card", previewColor: "#F0F0FF", rarity: "rare",      backColors: ["#F0F0FF", "#050515", "#1A1A55"], backAccent: "#4444AA" },
  { id: "face_autumn",     category: "card_design", name: "Otoño Dorado",       description: "Colores cálidos de la temporada.",        price: 120, preview: "card", previewColor: "#FFF8F0", rarity: "rare",      backColors: ["#FFF8F0", "#5A2A00", "#CC6600"], backAccent: "#FF8800" },
  { id: "face_winter",     category: "card_design", name: "Invierno Frío",      description: "Tonos fríos del invierno.",               price: 120, preview: "card", previewColor: "#F0F8FF", rarity: "rare",      backColors: ["#F0F8FF", "#001A2E", "#1155AA"], backAccent: "#3399FF" },
  ...
  { id: "face_olive",      category: "card_design", name: "Oliva",              description: "Verde militar clásico.",                  price: 130, preview: "card", previewColor: "#F8F8E8", rarity: "rare",      backColors: ["#F8F8E8", "#2A2A00", "#6A6A00"], backAccent: "#888800" },
  { id: "face_plum",       category: "card_design", name: "Ciruela",            description: "Morado oscuro intenso.",                  price: 140, preview: "card", previewColor: "#F8F0FF", rarity: "rare",      backColors: ["#F8F0FF", "#2A0040", "#660099"], backAccent: "#8800CC" },
  { id: "face_sienna",     category: "card_design", name: "Siena",              description: "Marrón rojizo de tierra italiana.",       price: 140, preview: "card", previewColor: "#FFF5EE", rarity: "rare",      backColors: ["#FFF5EE", "#3A1800", "#8B4513"], backAccent: "#AA5500" },
  { id: "face_denim",      category: "card_design", name: "Mezclilla",          description: "Azul jeans atemporal y casual.",          price: 140, preview: "card", previewColor: "#EEF2FF", rarity: "rare",      backColors: ["#EEF2FF", "#0A1830", "#1A3A6A"], backAccent: "#2255AA" },
  { id: "face_jade",       category: "card_design", name: "Jade Sagrado",       description: "Verde jade del lejano oriente.",          price: 150, preview: "card", previewColor: "#EDFFF8", rarity: "rare",      backColors: ["#EDFFF8", "#002A1A", "#00704A"], backAccent: "#00AA6A" },
  { id: "face_amber",      category: "card_design", name: "Ámbar",              description: "Dorado cálido de resina fósil.",          price: 150, preview: "card", previewColor: "#FFF8E0", rarity: "rare",      backColors: ["#FFF8E0", "#3A2000", "#BB8800"], backAccent: "#DDAA00" },
  { id: "face_charcoal",   category: "card_design", name: "Carbón",             description: "Gris oscuro con elegancia sobria.",       price: 140, preview: "card", previewColor: "#F0F0F0", rarity: "rare",      backColors: ["#F0F0F0", "#1A1A1A", "#555555"], backAccent: "#888888" },
  { id: "face_ocean",      category: "card_design", name: "Océano",             description: "Azul profundo del mar abierto.",          price: 150, preview: "card", previewColor: "#EEF8FF", rarity: "rare",      backColors: ["#EEF8FF", "#001830", "#004A7A"], backAccent: "#0077CC" },
  { id: "face_rose_gold",  category: "card_design", name: "Oro Rosa",           description: "Elegancia de oro rosado.",                price: 150, preview: "card", previewColor: "#FFF0EE", rarity: "rare",      backColors: ["#FFF0EE", "#3A1A10", "#CC7766"], backAccent: "#EE9988" },
  { id: "face_arctic",     category: "card_design", name: "Ártico",             description: "Frío y cristalino como el hielo.",        price: 140, preview: "card", previewColor: "#F0F8FF", rarity: "rare",      backColors: ["#F0F8FF", "#003050", "#66AACC"], backAccent: "#88CCEE" },
  { id: "face_parchment",  category: "card_design", name: "Pergamino",          description: "Histórico pergamino medieval.",           price: 130, preview: "card", previewColor: "#F8F0DC", rarity: "rare",      backColors: ["#F8F0DC", "#3A2800", "#7A5A20"], backAccent: "#9A7A30" },
  { id: "face_steel_blue", category: "card_design", name: "Acero Azul",         description: "Azul metálico industrial.",               price: 140, preview: "card", previewColor: "#EEF2F8", rarity: "rare",      backColors: ["#EEF2F8", "#101A2A", "#2A4A6A"], backAccent: "#4A7AAA" },
  { id: "face_copper",     category: "card_design", name: "Cobre Bruñido",      description: "Calidez oxidada del metal cobre.",        price: 150, preview: "card", previewColor: "#FFF0E8", rarity: "rare",      backColors: ["#FFF0E8", "#3A1A00", "#AA5500"], backAccent: "#CC7700" },
  // EPIC (25)
  { id: "face_neon_blue",  category: "card_design", name: "Neón Azul",          description: "Luz azul neón eléctrica.",                price: 200, preview: "card", previewColor: "#E8F0FF", rarity: "epic",      backColors: ["#0A0A20", "#001A40", "#0066FF"], backAccent: "#00AAFF" },
  { id: "face_neon_green", category: "card_design", name: "Neón Verde",         description: "Verde fluorescente electrizante.",        price: 200, preview: "card", previewColor: "#E8FFE8", rarity: "epic",      backColors: ["#050F05", "#001A00", "#00CC44"], backAccent: "#00FF66" },
  { id: "face_neon_red",   category: "card_design", name: "Neón Rojo",          description: "Rojo ardiente hipnótico.",                price: 200, preview: "card", previewColor: "#FFE8E8", rarity: "epic",      backColors: ["#150505", "#250000", "#CC0033"], backAccent: "#FF0044" },
  { id: "face_galaxy",     category: "card_design", name: "Galaxia",            description: "El universo en cada carta.",              price: 250, preview: "card", previewColor: "#F0EEFF", rarity: "epic",      backColors: ["#080820", "#100830", "#2A1560"], backAccent: "#6644CC" },
  { id: "face_cyberpunk",  category: "card_design", name: "Cyberpunk",          description: "Futuro distópico neón.",                  price: 250, preview: "card", previewColor: "#FFFFE0", rarity: "epic",      backColors: ["#0A0A00", "#151500", "#CCCC00"], backAccent: "#FFFF00" },
  { id: "face_lava",       category: "card_design", name: "Lava Volcánica",     description: "Fuego y destrucción a tu favor.",         price: 230, preview: "card", previewColor: "#FFE8E0", rarity: "epic",      backColors: ["#1A0500", "#300A00", "#CC3300"], backAccent: "#FF4400" },
  { id: "face_toxic",      category: "card_design", name: "Tóxico",             description: "Venenoso y peligroso.",                   price: 220, preview: "card", previewColor: "#E8FFE0", rarity: "epic",      backColors: ["#050F00", "#0A1A00", "#3A8000"], backAccent: "#88FF00" },
  { id: "face_shadow",     category: "card_design", name: "Sombra Oscura",      description: "Oscuridad que inspira temor.",            price: 230, preview: "card", previewColor: "#E8E8EE", rarity: "epic",      backColors: ["#0A0A10", "#101015", "#1A1A2A"], backAccent: "#3333AA" },
  { id: "face_amethyst",   category: "card_design", name: "Amatista",           description: "Gema violeta misteriosa y profunda.",     price: 250, preview: "card", previewColor: "#F5EEFF", rarity: "epic",      backColors: ["#100020", "#200040", "#440088"], backAccent: "#8844CC" },
  { id: "face_sapphire",   category: "card_design", name: "Zafiro Oscuro",      description: "Azul zafiro de joya real.",               price: 250, preview: "card", previewColor: "#E8EEFF", rarity: "epic",      backColors: ["#000A1A", "#001025", "#001A4A"], backAccent: "#0044BB" },
  { id: "face_ruby",       category: "card_design", name: "Rubí",               description: "Rojo rubí de piedra preciosa.",           price: 250, preview: "card", previewColor: "#FFE8EE", rarity: "epic",      backColors: ["#1A0008", "#28000F", "#660022"], backAccent: "#CC0033" },
  { id: "face_jade_dark",  category: "card_design", name: "Jade Imperial",      description: "Jade oscuro del palacio imperial.",       price: 260, preview: "card", previewColor: "#E8FFF4", rarity: "epic",      backColors: ["#000F08", "#001510", "#003020"], backAccent: "#006644" },
  { id: "face_aurora",     category: "card_design", name: "Aurora Boreal",      description: "Luces polares iridiscentes.",             price: 270, preview: "card", previewColor: "#EEFFFF", rarity: "epic",      backColors: ["#001515", "#002020", "#003A3A"], backAccent: "#00BBAA" },
  { id: "face_plasma",     category: "card_design", name: "Plasma",             description: "Estado de la materia incandescente.",     price: 280, preview: "card", previewColor: "#FFEEFF", rarity: "epic",      backColors: ["#100010", "#1A001A", "#440033"], backAccent: "#CC0088" },
  { id: "face_abyss",      category: "card_design", name: "Abismo",             description: "Profundidad oscura sin fondo.",           price: 280, preview: "card", previewColor: "#E8E8F5", rarity: "epic",      backColors: ["#020208", "#040410", "#080818"], backAccent: "#2222AA" },
  { id: "face_sunset_epic",category: "card_design", name: "Atardecer Épico",    description: "El atardecer más intenso jamás visto.",   price: 290, preview: "card", previewColor: "#FFF0E8", rarity: "epic",      backColors: ["#150800", "#220D00", "#771A00"], backAccent: "#FF4400" },
  { id: "face_storm",      category: "card_design", name: "Tormenta Eléctrica", description: "Rayos y poder en cada naipe.",            price: 290, preview: "card", previewColor: "#E8EEFF", rarity: "epic",      backColors: ["#050510", "#0A0A18", "#151530"], backAccent: "#5555FF" },
  { id: "face_ice_fire",   category: "card_design", name: "Fuego y Hielo",      description: "La dualidad de dos extremos.",            price: 300, preview: "card", previewColor: "#EEEEFF", rarity: "epic",      backColors: ["#0A0010", "#100520", "#200A40"], backAccent: "#4433CC" },
  { id: "face_matrix",     category: "card_design", name: "Matriz Digital",     description: "Código binario en cada carta.",           price: 310, preview: "card", previewColor: "#E8FFE8", rarity: "epic",      backColors: ["#000F00", "#001500", "#002800"], backAccent: "#00AA00" },
  { id: "face_obsidian",   category: "card_design", name: "Obsidiana",          description: "Vidrio volcánico negro perfecto.",        price: 320, preview: "card", previewColor: "#E8E8E8", rarity: "epic",      backColors: ["#050505", "#0A0A0A", "#121212"], backAccent: "#3A3A3A" },
  { id: "face_deep_space", category: "card_design", name: "Espacio Profundo",   description: "El vacío eterno entre estrellas.",        price: 330, preview: "card", previewColor: "#E8E8FF", rarity: "epic",      backColors: ["#000005", "#000008", "#000015"], backAccent: "#111166" },
  { id: "face_neon_gold",  category: "card_design", name: "Oro Neón",           description: "Dorado brillante bajo luz neón.",         price: 340, preview: "card", previewColor: "#FFFCE0", rarity: "epic",      backColors: ["#151000", "#221900", "#554400"], backAccent: "#FFCC00" },
  { id: "face_vortex",     category: "card_design", name: "Vórtice",            description: "Espiral de energía hipnótica.",           price: 340, preview: "card", previewColor: "#EEE8FF", rarity: "epic",      backColors: ["#050010", "#0A0020", "#1A0050"], backAccent: "#5500FF" },
  { id: "face_blaze",      category: "card_design", name: "Llamas",             description: "Fuego ardiente y consumidor.",            price: 350, preview: "card", previewColor: "#FFEEE0", rarity: "epic",      backColors: ["#180500", "#280A00", "#660000"], backAccent: "#FF2200" },
  { id: "face_prism",      category: "card_design", name: "Prisma",             description: "Espectro completo de color.",             price: 350, preview: "card", previewColor: "#FAFAFF", rarity: "epic",      backColors: ["#0A000A", "#15000F", "#280020"], backAccent: "#AA00AA" },
  // LEGENDARY (15)
  { id: "face_royal_gold", category: "card_design", name: "Oro Real",           description: "Lujo absoluto de los reyes.",             price: 400, preview: "card", previewColor: "#FFFBE8", rarity: "legendary", backColors: ["#1A1200", "#2A1E00", "#6A4E00"], backAccent: "#D4AF37" },
  { id: "face_blood_moon", category: "card_design", name: "Luna de Sangre",     description: "Eclipse total de poder oscuro.",          price: 420, preview: "card", previewColor: "#FFE8E0", rarity: "legendary", backColors: ["#110000", "#1E0000", "#440000"], backAccent: "#CC0000" },
  { id: "face_nether",     category: "card_design", name: "Inframundo",         description: "Oscuridad infernal más allá del velo.",   price: 440, preview: "card", previewColor: "#F5E8FF", rarity: "legendary", backColors: ["#0A0010", "#120018", "#2A003A"], backAccent: "#7700AA" },
  { id: "face_void",       category: "card_design", name: "El Vacío",           description: "La nada absoluta del cosmos.",            price: 450, preview: "card", previewColor: "#E8E8F8", rarity: "legendary", backColors: ["#000000", "#000002", "#000005"], backAccent: "#111133" },
  { id: "face_singularity",category: "card_design", name: "Singularidad",       description: "El punto de no retorno del universo.",    price: 460, preview: "card", previewColor: "#EEE8FF", rarity: "legendary", backColors: ["#02000A", "#050012", "#0A001E"], backAccent: "#3300AA" },
  { id: "face_celestial",  category: "card_design", name: "Celestial",          description: "Luz divina de los cielos.",               price: 470, preview: "card", previewColor: "#FFFFFF", rarity: "legendary", backColors: ["#F8FAFF", "#E8F0FF", "#D0E0FF"], backAccent: "#8899FF" },
  { id: "face_hellfire",   category: "card_design", name: "Fuego del Averno",   description: "Las llamas eternas del infierno.",        price: 480, preview: "card", previewColor: "#FFE0D8", rarity: "legendary", backColors: ["#1E0000", "#330000", "#880000"], backAccent: "#FF1100" },
  { id: "face_nirvana",    category: "card_design", name: "Nirvana",            description: "Paz absoluta e iluminación total.",       price: 490, preview: "card", previewColor: "#F8FFFF", rarity: "legendary", backColors: ["#F0FFFE", "#E0FFFB", "#C8FFF8"], backAccent: "#00EECC" },
  { id: "face_titan",      category: "card_design", name: "Titán",              description: "El poder de los titanes ancestrales.",    price: 500, preview: "card", previewColor: "#EEE8E0", rarity: "legendary", backColors: ["#1A1200", "#252000", "#3A3000"], backAccent: "#AA8800" },
  { id: "face_supernova",  category: "card_design", name: "Supernova",          description: "Explosión estelar de energía pura.",      price: 520, preview: "card", previewColor: "#FFEEFF", rarity: "legendary", backColors: ["#100008", "#1A0010", "#330020"], backAccent: "#DD0088" },
  { id: "face_myth",       category: "card_design", name: "Mitología",          description: "Cartas de los dioses y héroes.",          price: 540, preview: "card", previewColor: "#FFF8E8", rarity: "legendary", backColors: ["#1A1400", "#282000", "#504000"], backAccent: "#C8A000" },
  { id: "face_arcane",     category: "card_design", name: "Arcano",             description: "Magia prohibida en cada carta.",          price: 550, preview: "card", previewColor: "#F0E8FF", rarity: "legendary", backColors: ["#080010", "#100018", "#200030"], backAccent: "#9900FF" },
  { id: "face_eternal",    category: "card_design", name: "Eterno",             description: "Trasciende el tiempo y el espacio.",      price: 560, preview: "card", previewColor: "#F8F0FF", rarity: "legendary", backColors: ["#0A0818", "#140E28", "#1E1540"], backAccent: "#7755AA" },
  { id: "face_godlike",    category: "card_design", name: "Divino",             description: "Solo los mejores merecen estas cartas.",  price: 580, preview: "card", previewColor: "#FFFFF8", rarity: "legendary", backColors: ["#1A1800", "#282600", "#504C00"], backAccent: "#E8CC00" },
  { id: "face_omega",      category: "card_design", name: "Omega",              description: "El diseño final. La perfección suprema.", price: 600, preview: "card", previewColor: "#FAFAFA", rarity: "legendary", backColors: ["#050505", "#0A0A0A", "#111111"], backAccent: "#D4AF37" },
];
