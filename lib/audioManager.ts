...
const SOUNDS = {
  ...
  // Per-mode music loops (Task #113). Procedurally generated by
  // scripts/gen-mode-music.mjs so each mode has its own distinct loop
  // beneath the SFX layer.
  gameMusicPractice:   require("@/assets/sounds/game-music-practice.wav"),
  gameMusicClassic:    require("@/assets/sounds/game-music-classic.wav"),
  gameMusicLightning:  require("@/assets/sounds/game-music-lightning.wav"),
  gameMusicTournament: require("@/assets/sounds/game-music-tournament.wav"),
  gameMusicChallenge:  require("@/assets/sounds/game-music-challenge.wav"),
  gameMusicRanked:     require("@/assets/sounds/game-music-ranked.wav"),
  gameMusicCoop:       require("@/assets/sounds/game-music-coop.wav"),
...
function sourceForTrack(track: MusicTrack) {
  switch (track) {
    ...
    case "game_practice":    return SOUNDS.gameMusicPractice;
    case "game_classic":     return SOUNDS.gameMusicClassic;
    case "game_lightning":   return SOUNDS.gameMusicLightning;
    case "game_tournament":  return SOUNDS.gameMusicTournament;
    case "game_challenge":   return SOUNDS.gameMusicChallenge;
    case "game_ranked":      return SOUNDS.gameMusicRanked;
    case "game_coop":        return SOUNDS.gameMusicCoop;
    case "game":
    default:                 return SOUNDS.gameMusic;
  }
}
